...
contract Privileged {
     ...
     */
    modifier only(string memory _privilege) {
    ...
    function createPrivilege(string memory _privilegeName, address _owner, address _controller) public {
    ...
    function revokePrivilege(string memory _privilegeName) public {
        ...
        privileges[_privilegeName] = Privilege(address(0), address(0));
    }
     ...
     */
    function transferPrivilege(string memory _privilege, address _newOwner) public {
