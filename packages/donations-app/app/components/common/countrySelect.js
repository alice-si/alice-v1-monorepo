(function () {
  ...
  angular.module('aliceApp').directive('countrySelect', function () {
    var allCountries;
    allCountries = [
      {
        code: 'AF',
    ...
    return {
      ...
      template: '<select ng-options="country.code as country.name disable when country.disabled for country in countries">\
                   <option value="" disabled="disabled" selected="selected">{{prompt}}</option>\
                 </select>',
      controller: [
        '$scope', '$attrs', function ($scope, $attrs) {
          var countryCodesIn, findCountriesIn, includeOnlyRequestedCountries, removeCountry, removeExcludedCountries,
            separator, updateWithPriorityCountries;
          separator = {
            code: '-',
            name: '────────────────────',
            disabled: true
